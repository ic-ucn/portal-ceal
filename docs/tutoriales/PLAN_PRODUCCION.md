...
Revisión del 21 de septiembre de 2026. Un solo recorrido de aproximadamente 1 min 28 s, con encuadres de escritorio y teléfono, explica el portal público. Sustituye el video de 50 s, cuyos cambios de página no mostraban cómo navegar.
...
1. `npm run tutorial:audio`: voz `es-CL-CatalinaNeural` a ritmo normal, a partir de `scripts/portal-tutorial-story.json`. Los tiempos reservan navegación y pausas. Solo para sintetizar voz se reemplaza «portal» por «portál»; subtítulos y pantalla mantienen «portal».
...
Salidas en `assets/tutorial/`: `portal-guia-desktop.mp4`, `portal-guia-mobile.mp4`, carteles JPEG y VTT por encuadre. Capturas, voz, música y manifests intermedios permanecen en `.data/portal-guide-v3/`, fuera de Git. Los tutoriales históricos de atención/gestión no se reactivan ni se publican con esta entrega.
