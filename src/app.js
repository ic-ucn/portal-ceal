(() => {
  ...
  const DATA_CONTENT_VERSION = '20260617h';
  const LOCAL_DATA_KEY = 'portal.data.v13';
  const STALE_DATA_KEYS = ['portal.data.v6', 'portal.data.v7', 'portal.data.v8', 'portal.data.v9', 'portal.data.v10', 'portal.data.v11', 'portal.data.v12'];
  ...
  function renderLogin() {
    ...
    return `<main class="login-shell"><section class="login-card" aria-label="Ingreso al portal">
      <div class="login-brand"><div><img src="assets/logo-horizontal.png" alt="CEIC UCN Ingeniería Civil UCN" /><h1>Portal CEIC / CEAL UCN</h1><p>Consulta material, mallas, fechas, comunicados y contingencia de Ingeniería Civil UCN.</p></div></div>
  ...
  function renderShell(content, path) {
    ...
    return `<div class="${shellClass}"><aside class="sidebar"><a class="sidebar-brand" href="#/"><span class="brand-mark"><img src="assets/logo-mark.png" alt="CEIC UCN" /></span><span class="brand-copy"><strong>CEIC UCN</strong><span>INGENIERÍA CIVIL UCN</span></span></a><a class="sidebar-campus" href="#/"><img src="assets/ucn-campus-line.png" alt="" /><span><strong>Portal académico</strong><small>UCN Antofagasta</small></span></a><nav class="nav">${nav}</nav></aside>
  ...
  function renderHome() {
    ...
    return `${pageHead('Inicio', 'Resumen actualizado del portal académico')}
      ...
      <a class="home-campus-card" href="#/mallas" aria-label="Abrir mallas del portal CEIC UCN"><img src="assets/ucn-campus-line.png" alt="Ilustración lineal de la entrada de Universidad Católica del Norte" /><span class="home-campus-copy"><strong>Ingeniería Civil UCN</strong><span>Portal académico CEIC / CEAL</span></span></a></section>
      <section class="card pad home-actions-panel home-actions-section"><div class="row-between"><h2 class="card-title">Acciones frecuentes</h2><span class="pill blue">Accesos rápidos</span></div><div class="access-grid home-actions-grid">${access('grid','Abrir mallas','Plan O y Plan P en vista inmersiva.','Ver malla','/mallas','blue')}${access('book','Buscar material','Guías, pruebas, apuntes y PPT.','Abrir','/material')}${access('calendar','Ver calendario','Fechas académicas oficiales 2026.','Abrir','/calendario')}${access('file','Contingencia del paro','Comunicados, compromisos y seguimiento.','Revisar','/contingencia','orange')}</div></section>
