(() => {
  ...
  const DATA_CONTENT_VERSION = '20260617g';
  const LOCAL_DATA_KEY = 'portal.data.v12';
  const STALE_DATA_KEYS = ['portal.data.v6', 'portal.data.v7', 'portal.data.v8', 'portal.data.v9', 'portal.data.v10', 'portal.data.v11'];
